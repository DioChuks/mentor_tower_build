...
const _logger_1 = __importDefault(require("./_logger"));
...
const successHandler = (0, morgan_1.default)(successResponseFormat, {
    ...
    stream: { write: (message) => _logger_1.default.info(message.trim()) },
});
const errorHandler = (0, morgan_1.default)(errorResponseFormat, {
    skip: (_req, res) => res.statusCode < 400,
    stream: { write: (message) => _logger_1.default.error(message.trim()) },
});
const _morgan = {
    getIpFormat,
