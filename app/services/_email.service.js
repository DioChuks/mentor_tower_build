...
if (config_1.default.env !== 'test') {
    exports.transport
        .verify()
        .then(() => _logger_1.default.info('Connected to email server'))
        .catch(() => _logger_1.default.warn('Unable to connect to email server. Make sure you have configured the SMTP options in .env'));
}
